                ...
                <Card.Body style={{ padding: "15px" }}>
                  ...
                  <div className="row text-center mb-3">
                    <div className="col-4 border-end">
                      ...
                      <small className="text-muted">{t("OtherMedicationMobileView.dosage")}</small>
                    </div>
                    <div className="col-4 border-end">
                      <div className="fw-bold text-primary">{prescription.duration}</div>
                      <small className="text-muted">{t("OtherMedicationMobileView.duration")}</small>
                    </div>
                    <div className="col-4 pl-0 pr-1">
                      ...
                      <small className="text-muted">{t("OtherMedicationMobileView.status")}</small>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      {t("OtherMedicationMobileView.view_all_details")}
                    </Button>
                  </div>
                </Card.Body>
              </Card>
      ...
      >
        ...
        <Modal.Body className="space-y-4 pt-0">
          <div className="row">
            <div className="col-6">
              <Field
                label={t("OtherMedicationMobileView.dosage")}
            ...
            <div className="col-6">
              <Field
                label={t("OtherMedicationMobileView.duration")}
          ...
          <Field
            label={t("OtherMedicationMobileView.status")}
            value={
              selectedMedication?.status
                ? t(`Common.status_options.${selectedMedication.status}`)
                : ""
            }
            disabled
          ...
          <TextAreaField
            label={t("OtherMedicationMobileView.instructions")}
        ...
        <Modal.Footer className="border-top-0">
          <button className="dc-btn dc-cancel-btn" onClick={handleCloseModal}>
            {t("OtherMedicationMobileView.close")}
          </button>
        </Modal.Footer>
      </Modal>
    </div>
