  ...
  return (
    <div className="table-container mobile-view-card">
      <div className="table-header">
        <div>
          <h3 className="table-title">Diagnosed Conditions List</h3>
              ...
              return (
                ...
                >
                  <Card.Body style={{ padding: "15px" }}>
                    ...
                    <div className="mb-2">
                      <small className="text-muted d-block mb-1">Diagnosis Name:</small>
      ...
      >
        ...
        <Modal.Body className="space-y-4 pt-0">
          <Field  label="Diagnosis Name" value={selectedCondition?.diagnosisName} disabled/>
