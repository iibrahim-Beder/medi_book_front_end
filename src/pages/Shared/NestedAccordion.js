          ...
          <li key={item.id || index}>
            ...
            >
              <span>
                ...
                {item.DiagnosisName || item.type || "New Diagnosis"}{" "}
                <em>{item.date}</em>
                {item.isNew && (
            ...
            <div
              style={{
                ...
                borderBottom: `${
                  index === data.length - 1 ? "1px solid #eee" : ""
                }`,
              }}
                  ...
                  {onAddCondition &&
                    ...
                    onSaveCondition && (
                      ...
                      title="Diagnosed Conditions"
                        ...
                        onUpdate={(conditionIndex, field, value) =>
                          onUpdateCondition(index, conditionIndex, field, value)
                        }
                  ...
                  {onAddNote && onDeleteNote && (
                    <div className="dc-notes">
                      <EditableList
                        ...
                        onDeleteItem={(noteIndex) =>
                          onDeleteNote(index, noteIndex)
                        }
                  ...
                  {onAddPrescription &&
                    ...
                    onSavePrescription && (
                      <TwoLevelAccordion
                        ...
                        formFields={formFieldsPrescription}
                        formFieldsRecipe={formFieldsRecipe} 
                        onAdd={() => onAddPrescription(index)}
                        onDelete={(prescriptionIndex) =>
                          onDeletePrescription(index, prescriptionIndex)
                        }
                        onUpdate={(prescriptionIndex, field, value) =>
                          onUpdatePrescription(
                            index,
                            prescriptionIndex,
                            field,
                        ...
                        onSave={(prescriptionIndex, prescriptionData) =>
                          onSavePrescription(
                            index,
                            prescriptionIndex,
                            prescriptionData
                        ...
                        onAddRecipe={(prescriptionIndex) =>
                          onAddRecipe(index, prescriptionIndex)
                        }
                        onDeleteRecipe={(prescriptionIndex, recipeIndex) =>
                          onDeleteRecipe(index, prescriptionIndex, recipeIndex)
                        }
                        onUpdateRecipe={(
                          prescriptionIndex,
                          recipeIndex,
