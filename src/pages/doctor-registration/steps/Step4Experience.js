      ...
      <fieldset>
        <div className="form-group form-group-half">
          <Field
            ...
            error={errors[`experience_${index}_companyTitle`]}  
...
export default function Step4Experience({ 
  ...
  initialExperiences = [],   // ← This will come from Redux
  onChange = () => {}        // ← Will send updates back to parent (DoctorRegistration)
}) {
  const { t } = useTranslation();
  ...
  // Whenever experiences change, send them to parent
  useEffect(() => {
  ...
  return (
    <div className="dc-userexperience dc-tabsinfo">
      ...
      {console.log("Rendering single experience form with errors:", experiences, errors, forceShowError)}
